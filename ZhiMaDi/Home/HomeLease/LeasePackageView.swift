...
//            
//        }
        let btn = ZMDTool.getButton(CGRect(x: self.bounds.width/2 - 55, y: 12, width: 110, height: 65 - 24), textForNormal: "立即租赁", fontSize: 15, backgroundColor:  RGB(235,61,61,1.0),blockForCli : {(sender) -> Void in
