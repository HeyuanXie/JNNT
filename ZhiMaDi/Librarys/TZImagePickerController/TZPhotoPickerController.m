...
- (void)configCollectionView {
    ...
    //从UINavigationController跳转过来top设置为0
    //从UIViewController跳转过来top设置为44
    //CGFloat top = 44;
    //if (iOS7Later) top += 20;
    CGFloat top = 0;
    if (iOS7Later) top += 0;
    CGFloat collectionViewHeight = tzImagePickerVc.maxImagesCount > 1 ? self.view.tz_height - 50 - top : self.view.tz_height - top;
    //从UINavigationController跳转过来top为0,所以collectionView的height变高了44，遮挡了bottomToolBar
    collectionViewHeight = collectionViewHeight - 44 - 20;
